                ...
                <table class="table mb-0">
                    ...
                    <tbody class="ligth-body">
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="badge badge-primary">{{ \Carbon\Carbon::parse($attendance->date)->format('l, d F Y') }}</span>
                            </td>
                            <td>
                                <div class="d-flex align-items-center justify-content-center list-action">
                                    <a class="btn btn-warning mr-2" data-toggle="tooltip" data-placement="top" title="Edit" href="{{ route('attendance.edit', $attendance->date) }}">
                        ...
                        @empty
                        <tr>
                            <td colspan="3" class="text-center text-muted">No attendance records found. Click "Create" to add new.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
