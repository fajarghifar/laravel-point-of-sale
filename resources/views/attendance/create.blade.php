            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div class="header-title">
                        <h4 class="card-title">Create Employee Attendance</h4>
                    </div>
                </div>
                    ...
                    <form action="{{ route('attendance.store') }}" method="POST">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input id="datepicker" class="form-control @error('date') is-invalid @enderror" name="date" value="{{ old('date') }}" autocomplete="off" />
                                @error('date')
                                                        ...
                                                        <div class="input-group justify-content-center">
                                                            ...
                                                            <div class="input-group-text bg-transparent border-0">
                                                                <div class="custom-control custom-radio custom-control-inline">
                                                                    <input type="radio" id="present{{ $key }}" name="status{{ $key }}" class="custom-control-input set-present" value="present">
                                                            ...
                                                            <div class="input-group-text bg-transparent border-0">
                                                                <div class="custom-control custom-radio custom-control-inline">
                                                                    <input type="radio" id="leave{{ $key }}" name="status{{ $key }}" class="custom-control-input set-leave" value="leave">
                                                            ...
                                                            <div class="input-group-text bg-transparent border-0">
                                                                <div class="custom-control custom-radio custom-control-inline">
                                                                    <input type="radio" id="absent{{ $key }}" name="status{{ $key }}" class="custom-control-input set-absent" value="absent">
