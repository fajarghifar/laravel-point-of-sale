                ...
                <table class="table mb-0">
                    ...
                    <tbody class="ligth-body">
                        ...
                        <tr>
                            ...
                            <td>${{ $advance_salary->employee->salary }}</td>
                            <td>{{ $advance_salary->advance_salary ? '$'.$advance_salary->advance_salary : 'No Advance' }}</td>
                            <td>${{ $advance_salary->employee->salary - $advance_salary->advance_salary }}</td>
                            <td>
                                <div class="d-flex align-items-center list-action">
                                    <a class="badge bg-info mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="Pay Now"
                                        href="{{ route('pay-salary.show', $advance_salary->id) }}">Pay Now</i>
                                    </a>
                                </div>
                            </td>
                        </tr>
